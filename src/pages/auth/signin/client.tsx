    ...
    if (success && token) {
      ...
      userMutation({ userId: userId as Id<'users'> }).then((res) => {
        if (res.type !== 'client') {
          ...
          setSuccess(false);
          setErrorMessage(
            'This account already exists as a vendor. Please sign in as a vendor.',
          );
        } else {
    ...
    <div className="flex min-h-screen items-center justify-center p-8">
      ...
      <div className="flex size-full max-w-sm flex-col items-center gap-4">
        ...
        <div className="rounded-lg bg-black px-8 py-12 opacity-70 shadow-lg">
          <h2 className="mb-4 text-2xl font-bold text-white">Client Sign in</h2>
          ...
          <form onSubmit={onSubmit}>
            ...
            <button
              type="submit"
              className="hover:bg-pritext-primary-azureBlue w-full rounded-md bg-blue-600 py-2 text-white transition duration-200 disabled:bg-blue-400"
              disabled={submitting}
            >
